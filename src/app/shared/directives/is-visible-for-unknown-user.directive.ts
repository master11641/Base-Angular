...
@Directive({
  selector: "[isVisibleForUnknownUser]"
})
export class IsVisibleForUnknownUserDirective implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.changeVisibility(this.authService.isLoggedIn());
  }
